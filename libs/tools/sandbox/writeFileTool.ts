...
export default createTool({
  description: 'Write a content to a file in a sandbox environment, will return file content and current sandbox id which can be re-used to connect to the sandbox.',
  parameters: z.object({
    sandboxId: z.string()
      .optional()
      .nullable()
