...
import { z } from 'zod';
import type { SandboxWriteFileParams, SandboxWriteFileResult } from '../types';
...
export default createTool({
  ...
  execute: async ({ sandboxId, entries }: SandboxWriteFileParams): Promise<SandboxWriteFileResult> => {
    let sandbox;
    try {
